try {    // Tạo container chứa các button và thêm vào góc phải dưới cùng màn hình
    ...
    (function() {
        ...
        watermark.textContent = 'KHỞI TẠO BUTTON THÀNH CÔNG (update 12:52AM 13/12/2024) ducanhwork26';  // Nội dung watermark
        ...
        watermark.style.color = 'rgb(255, 0, 25)';  // Màu sắc watermark (mờ dần)
