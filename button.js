try {    // Tạo container chứa các button và thêm vào góc phải dưới cùng màn hình
    ...
    createButton('Nhập số trang', () => {
        const soTrangSelectElement = document.querySelector('select[name="attributes_44[]"]');
        ...
        try {    // Tạo container chứa các button và thêm vào góc phải dưới cùng màn hình
            ...
            (function() {
                ...
                try {    // Tạo container chứa các button và thêm vào góc phải dưới cùng màn hình
                    ...
                    // Nhập số trang
                    createButton('Nhập số trang', () => {
                        const soTrangSelectElement = document.querySelector('select[name="attributes_45[]"]');
                        const soTrang = prompt('Nhập số trang tài liệu (1, 2, 3,...):');
                        const soTrangOptions = Array.from(soTrangSelectElement.options);
                        const selectedSoTrangOption = soTrangOptions.find(option => option.value === soTrang);
                    ...
                    // Thiết lập ngôn ngữ mặc định (Tiếng Việt)
                    document.querySelector('select[name="attributes_54[]"]').value = "Tiếng Việt"; // Ngôn ngữ mặc định là Tiếng Việt
                    // Thiết lập giá trị mặc định khác (không cần nhập)
                    // document.querySelector('select[name="attributes_37[]"]').value = "DOCX"; // Định dạng tài liệu là DOCX
                    // Chọn tất cả các option có giá trị là "DOCX" và đánh dấu là selected
                    document.querySelectorAll('select[name="attributes_36[]"] option[value="DOCX"]').forEach(option => {
                        option.selected = true;
                      });
                    ...
                    (function() {
                        ...
                        try {    // Tạo container chứa các button và thêm vào góc phải dưới cùng màn hình
                            ...
                            // Nhập số trang
                            createButton('Nhập số trang', () => {
                                const soTrangSelectElement = document.querySelector('select[name="attributes_43[]"]');
                                const soTrang = prompt('Nhập số trang tài liệu (1, 2, 3,...):');
                                const soTrangOptions = Array.from(soTrangSelectElement.options);
                                const selectedSoTrangOption = soTrangOptions.find(option => option.value === soTrang);
                            ...
                            // Thiết lập ngôn ngữ mặc định (Tiếng Việt)
                            document.querySelector('select[name="attributes_52[]"]').value = "Tiếng Việt"; // Ngôn ngữ mặc định là Tiếng Việt
                            // Thiết lập giá trị mặc định khác (không cần nhập)
                            // document.querySelector('select[name="attributes_37[]"]').value = "DOCX"; // Định dạng tài liệu là DOCX
                            // Chọn tất cả các option có giá trị là "DOCX" và đánh dấu là selected
                            document.querySelectorAll('select[name="attributes_34[]"] option[value="DOCX"]').forEach(option => {
                                option.selected = true;
                              });
                            ...
                            (function() {
                                ...
                                // Đặt nội dung của watermark
                                watermark.textContent = 'KHỞI TẠO BUTTON THÀNH CÔNG 11:42PM 12/12/2024';  // Nội dung watermark
